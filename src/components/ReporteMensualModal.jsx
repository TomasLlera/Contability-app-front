    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-md p-6" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mb-5">
          Compara el saldo de cada subrubro de <strong className="text-slate-700 dark:text-slate-200">{rubro.nombre}</strong> con el mes anterior: diferencia, % de cambio y tendencia, con barras de evolución.
        </p>
